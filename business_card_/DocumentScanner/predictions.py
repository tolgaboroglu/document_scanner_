...
### Load NER model
model_ner = spacy.load('C:/Users/tolga/business_card_/BusinessCardNER/output/model-best')
...
def getPredictions(image):
    ...
    for l, r, t, b, label, token in img_tagging.values:
        ...
        cv2.putText(img_bb, str(label), (int(l), int(t)), cv2.FONT_HERSHEY_PLAIN, 1, (255, 0, 255), 2)
